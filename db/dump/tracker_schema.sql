...
--
-- Host: tracker-prod.crykeebdajmp.ap-southeast-1.rds.amazonaws.com    Database: kyber_tracker
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=207105 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4621817 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rate7d` (
  ...
  KEY `base_symbol` (`base_symbol`),
  KEY `quote_symbol` (`quote_symbol`)
) ENGINE=InnoDB AUTO_INCREMENT=4621694 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-02-11  7:16:55
