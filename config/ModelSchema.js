...
module.exports = {
  ...
  KyberTradeModel:
  {
    ...
    fee_token: { type: 'string', length: 765 },
    fee_platform_wallet: { type: 'string', length: 765 },
    fee_platform: { type: 'string', length: 765 },
    fee_rebate: { type: 'string', length: 765 },
    fee_burn_atm: { type: 'string', length: 765 },
    fee_total_collected: { type: 'string', length: 765 },
  },
  ReserveTradeModel: {
    reserve_id: { type: 'string', length: 255 },
    reserve_address: { type: 'string', length: 255 },
    tx: { type: 'string', length: 255 },
    unique_tag: { type: 'string', length: 255 },
    block_number: { type: 'number', length: 11 },
    block_timestamp: { type: 'number', length: 11 },
    source_address: { type: 'string', length: 255 },
    source_token_address: { type: 'string', length: 255 },
    source_token_symbol: { type: 'string', length: 255 },
    source_token_decimal: { type: 'number', length: 11 },
    dest_address: { type: 'string', length: 255 },
    dest_token_address: { type: 'string', length: 255 },
    dest_token_symbol: { type: 'string', length: 255 },
    dest_token_decimal: { type: 'number', length: 11 },
    source_amount: { type: 'number', length: 11 },
    dest_amount: { type: 'number', length: 11 },
    rate: { type: 'number', length: 11 },
    value_eth: { type: 'number', length: 11 },
    value_usd: { type: 'number', length: 11 },
  },
  FeeDistributedModel: {
    tx: { type: 'string', length: 300 },
    unique_tag: { type: 'string', length: 300 },
