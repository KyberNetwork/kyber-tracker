...
export default {
  data() {
    return {
      ...
      isOpenFee: false,
      isShowInfoBar: true,
      infoBarUrl: "https://kyberswap.com/promo/ogn?utm_source=kn-tracker&utm_medium=notibar&utm_campaign=ogn-contest",
      infoBarMess: "$8,000 to be won in OGN trading contest on KyberSwap!",
      infoBarTimeFrom: 1596506400000,
      infoBarTimeTo: 1597431540000,
      indexShowmore: -1,
