...
export default {
  data() {
    return {
      ...
      isOpenFee: false,
      isShowInfoBar: true,
      infoBarUrl: "https://kyberswap.com/promo/band?utm_source=kn-tracker&utm_medium=notibar&utm_campaign=band-contest",
      infoBarMess: "$6,000 to be won in BAND trading contest on KyberSwap!",
      infoBarTimeFrom: 1586264400000,
      infoBarTimeTo: 1587052800000,
      indexShowmore: -1,
